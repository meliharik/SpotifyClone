...
//  SpotifyClone
//
//  Created by melih arik on 12/12/22.
//
...
class RecommendedTrackCollectionViewCell: UICollectionViewCell {
    ...
    override func layoutSubviews() {
        ...
        artistNameLabel.frame = CGRect(x: albumCoverImageView.right+20, y: contentView.height/2, width: contentView.width-albumCoverImageView.right-15, height: contentView.height/2)
